...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const allowedCitiesByStateName = {
    ...
    "Bahia": ["Alagoinhas","Barra","Barreiras","Bom Jesus da Lapa","Brumado","Caetité","Camaçari",
              "Campo Formoso","Candeias","Casa Nova","Conceição do Coité","Cruz das Almas","Dias d'Ávila",
              ...
              "Paulo Afonso","Porto Seguro","Ribeira do Pombal","Salvador","Santo Amaro",
              "Santo Antônio de Jesus","Santo Estêvão","São Francisco do Conde","São Sebastião do Passé",
              "Senhor do Bonfim","Serrinha","Simões Filho","Teixeira de Freitas","Valença","Vitória da Conquista"],
    "Ceará": ["Acaraú","Aquiraz","Aracati","Barbalha","Beberibe","Boa Viagem","Brejo Santo","Camocim",
              ...
              "São Gonçalo do Amarante","Sobral","Tauá","Tianguá","Trairi","Viçosa do Ceará"],
    "Distrito Federal": ["Brasília"],
    "Espírito Santo": ["Aracruz","Cachoeiro de Itapemirim","Cariacica","Colatina","Fundão","Guarapari",
                       "Linhares","São Mateus","Serra","Viana","Vila Velha","Vitória"],
    "Goiás": ["Abadia de Goiás","Águas Lindas de Goiás","Anápolis","Aparecida de Goiânia","Aragoiânia",
              ...
              "Novo Gama","Padre Bernardo","Planaltina","Rio Verde","Santo Antônio de Goiás",
    ...
    "Maranhão": ["Açailândia","Bacabal","Balsas","Barra do Corda","Barreirinhas","Buriticupu","Caxias",
                 ...
                 "Tutóia","Viana"],
    "Mato Grosso": ["Alta Floresta","Barra do Garças","Cáceres","Cuiabá","Lucas do Rio Verde",
                    "Nova Mutum","Pontes e Lacerda","Primavera do Leste","Rondonópolis","Sinop",
    ...
    "Paraná": ["Almirante Tamandaré","Apucarana","Arapongas","Araucária","Balsa Nova","Bocaiúva do Sul",
               ...
               "Paranaguá","Paranavaí","Pato Branco","Pinhais","Piraquara","Ponta Grossa",
               "Presidente Castelo Branco","Quatro Barras","Rio Branco do Sul","Rolândia",
    ...
    "Pernambuco": ["Abreu e Lima","Araçoiaba","Araripina","Arcoverde","Belo Jardim","Bezerros","Buíque",
                   ...
                   "Santa Cruz do Capibaribe","São Lourenço da Mata","Serra Talhada","Surubim",
                   "Vitória de Santo Antão"],
    "Piauí": ["Floriano","Parnaíba","Picos","Piripiri","Teresina"],
    "Rio de Janeiro": ["Angra dos Reis","Araruama","Armação dos Búzios","Arraial do Cabo","Barra do Piraí",
    ...
    "Rio Grande do Sul": ["Alegrete","Alvorada","Araricá","Arroio do Padre","Bagé","Bento Gonçalves",
                          "Cachoeira do Sul","Cachoeirinha","Camaquã","Campo Bom","Canoas","Capão da Canoa",
                          ...
                          "Santo Ângelo","São Borja","São Gabriel","São José do Hortêncio","São Leopoldo",
    ...
    "Santa Catarina": ["Águas Mornas","Antônio Carlos","Araquari","Araranguá","Balneário Camboriú",
                       ...
                       "Gaspar","Governador Celso Ramos","Içara","Ilhota","Imbituba","Indaial","Itajaí",
    ...
    "São Paulo": ["Alfredo Marcondes","Alumínio","Álvares Machado","Americana","Amparo","Andradina",
                  ...
                  "Franco da Rocha","Guapiaçu","Guaratinguetá","Guarujá","Guarulhos","Hortolândia",
                  ...
                  "Jaguariúna","Jambeiro","Jandira","Jardinópolis","Jarinu","Jaú","Jundiaí","Leme",
                  ...
                  "Ribeirão Pires","Ribeirão Preto","Rio Claro","Rio das Pedras","Rio Grande da Serra",
                  "Salesópolis","Saltinho","Salto","Salto de Pirapora","Santa Bárbara d'Oeste",
                  "Santa Branca","Santa Cruz da Esperança","Santa Isabel","Santana de Parnaíba",
